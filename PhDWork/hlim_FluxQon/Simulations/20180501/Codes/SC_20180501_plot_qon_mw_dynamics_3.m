function SC_20180501_plot_qon_mw_dynamics_3(n,varargin)
%% Settings
Groot.usedefault();
...
FIGURE_LABEL_STRING={...
	'(a) $\Delta=-\frac{1}{4}\,\omega$','(b)';
	'(c) $\Delta=0$','(d)';
	'(e) $\Delta=\frac{1}{4}\,\omega$','(f)';
	'(g) $\Delta=\frac{1}{2}\,\omega$','(h)'};
...
Y=cell(M,N);
for i=1:M
	S=loaddata('R','qon','mw','dynamics',n,0,D(i),...
