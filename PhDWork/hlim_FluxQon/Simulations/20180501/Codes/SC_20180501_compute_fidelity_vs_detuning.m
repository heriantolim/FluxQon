function cID=SC_20180501_compute_fidelity_vs_detuning(n,varargin)
...
V=cell(numel(S.NumPhotons),numel(S.Detuning));
S.Time=V;
S.Number=V;
S.Fidelity=V;
i=0;
...
cID=[{'fidelity','vs','detuning',...
	P.CalcMode,P.CouplingRatio,P.Concentration},cID];
